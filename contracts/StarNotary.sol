...
contract StarNotary is ERC721 {
    ...
    string public name = "Star Tracker";
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        ...
        require(!isStringsEquals(tokenIdToStarInfo[_tokenId].name, ""), "There is no star linked to this token");
        return tokenIdToStarInfo[_tokenId].name;       
    }

    function isStringsEquals(string memory a, string memory b) internal pure returns (bool) {
